...
object Plugins {
  ...
  val android41x: Agp = Agp("com.android.tools.build:gradle:4.1.0-beta02", requiresGradle = "6.5-rc-1")
  val android42x: Agp = Agp("com.android.tools.build:gradle:4.2.0-alpha03", requiresGradle = "6.5")
