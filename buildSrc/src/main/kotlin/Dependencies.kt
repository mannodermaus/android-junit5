...
object Plugins {
  ...
  val android42x: Agp = Agp("com.android.tools.build:gradle:4.2.0-beta05", requiresGradle = "6.7.1")
  val android70x: Agp = Agp("com.android.tools.build:gradle:7.0.0-alpha08", requiresGradle = "6.8.2")
