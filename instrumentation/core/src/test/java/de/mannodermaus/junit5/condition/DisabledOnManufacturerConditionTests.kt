 ...
 *
 * This works together with [DisabledOnManufacturerIntegrationTests]: The test methods in both
...
class DisabledOnManufacturerConditionTests : AbstractExecutionConditionTests() {
    ...
    fun invalidBecauseArrayIsEmpty() {
        ...
        assertThat(expected)
            .hasMessageThat()
            .contains("You must declare at least one Manufacturer in @DisabledOnManufacturer")
    }
