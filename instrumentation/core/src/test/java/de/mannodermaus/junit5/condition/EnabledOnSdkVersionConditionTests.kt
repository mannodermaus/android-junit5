 ...
 *
 * This works together with [EnabledOnSdkVersionIntegrationTests]: The test methods in both classes
...
class EnabledOnSdkVersionConditionTests : AbstractExecutionConditionTests() {
    ...
    fun invalidBecauseNoValueGiven() {
        ...
        assertThat(expected)
            .hasMessageThat()
            .contains("At least one value must be provided in @EnabledOnSdkVersion")
    }
