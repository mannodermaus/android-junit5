 ...
 *
 * This works together with [EnabledOnManufacturerIntegrationTests]: The test methods
...
class EnabledOnManufacturerConditionTests : AbstractExecutionConditionTests() {
  ...
  fun invalidBecauseArrayIsEmpty() {
    ...
    assertThat(expected).hasMessageThat().contains("You must declare at least one Manufacturer in @EnabledOnManufacturer")
  }
