 ...
 *
 * This works together with [DisabledOnSdkVersionIntegrationTests]: The test methods in both classes
 * MUST be named identical.
 */
class DisabledOnSdkVersionConditionTests : AbstractExecutionConditionTests() {
    ...
    fun invalidBecauseNoValueGiven() {
        ...
        assertThat(expected)
            .hasMessageThat()
            .contains("At least one value must be provided in @DisabledOnSdkVersion")
    }
