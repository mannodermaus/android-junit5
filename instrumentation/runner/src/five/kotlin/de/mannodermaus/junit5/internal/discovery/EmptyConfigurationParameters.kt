...
/**
 * JUnit 5 version of the [ConfigurationParameters] interface, including the deprecated APIs that
 * were removed in subsequent versions of the framework.
 */
@RequiresApi(26)
internal object EmptyConfigurationParameters : ConfigurationParameters {
    ...
    @Deprecated("Deprecated in Java", ReplaceWith("keySet().size")) override fun size() = 0
}
