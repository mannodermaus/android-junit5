...
import de.mannodermaus.gradle.plugins.junit5.GroovyInterop
 ...
 * that connect to an [AndroidJUnit5Test] in some shape or form.
 */
abstract class JUnit5TaskConfigAction<T : Task>(
    protected val project: Project,
    protected val testTask: AndroidJUnit5Test
) : TaskConfigAction<T> {

  protected val variant: BaseVariant = testTask.variant
  protected val scope: VariantScope = GroovyInterop.scopeOf(variant)
