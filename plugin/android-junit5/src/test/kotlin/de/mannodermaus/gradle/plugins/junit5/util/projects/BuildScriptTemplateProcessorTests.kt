...
class BuildScriptTemplateProcessorTests {
    ...
    @Test
    fun `works with brackets`() =
        runTest(
            replacements = mapOf("VALUE" to "hello"),
            rawText =
                """
      val value = "{{ VALUE }}"
      if (123 == 456) {
    ...
    @Test
    fun `substitution with existing value`() =
        runTest(
            replacements = mapOf("VALUE" to "hello"),
            rawText =
                """
    ...
    @Test
    fun `substitution with missing value`() =
        runTest(
            replacements = mapOf(),
            rawText =
                """
    ...
    @Test
    fun `ifelse with first block winning`() =
        runTest(
            replacements = mapOf("VALUE" to true),
            rawText =
                """
      {% if VALUE %}
      val value = 1234
    ...
    @Test
    fun `ifelse with second block winning`() =
        runTest(
            replacements = mapOf("VALUE" to false),
            rawText =
                """
      {% if VALUE %}
      val value = 1234
    ...
    @Test
    fun `ifelseif with first block winning`() =
        runTest(
            replacements = mapOf("VALUE" to true, "VALUE2" to true),
            rawText =
                """
      {% if VALUE %}
      val value = 1234
    ...
    @Test
    fun `ifelseif with second block winning`() =
        runTest(
            replacements = mapOf("VALUE" to false, "VALUE2" to true),
            rawText =
                """
      {% if VALUE %}
      val value = 1234
    ...
    @Test
    fun `ifelseif with third block winning`() =
        runTest(
            replacements = mapOf("VALUE" to false, "VALUE2" to false),
            rawText =
                """
      {% if VALUE %}
      val value = 1234
    ...
    @Test
    fun `empty loop won't emit anything`() =
        runTest(
            replacements = mapOf("VALUES" to listOf<String>()),
            rawText =
                """
      println("before")
      {% for item in VALUES %}
    ...
    @Test
    fun `loop will emit something`() =
        runTest(
            replacements = mapOf("VALUES" to listOf("value 1", "value 2")),
            rawText =
                """
      println("before")
      {% for item in VALUES %}
    ...
    fun `loop with nested conditional`() =
        runTest(
            replacements = mapOf("ENABLED" to false, "VALUES" to listOf("value 1", "value 2")),
            rawText =
                """
      println("before")
      {% for item in VALUES %}
    ...
    private fun runTest(replacements: Map<String, Any>, rawText: String, expectedText: String) =
        runBlocking {
