...
/**
 * Processor class for virtual build script files, used by Functional Tests. It utilizes a template
 * engine to customize the processed output for the build scripts injected into the virtual
 * projects, based around template files located within src/test/resources.
 */
class BuildScriptTemplateProcessor(
    ...
    fun process(fileName: String): String = runBlocking { renderer.render(fileName, replacements) }
