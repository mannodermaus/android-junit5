...
class TestEnvironment {
  ...
  private static
  final ENVIRONMENT_RESOURCE_NAME = "/de/mannodermaus/gradle/plugins/junit5/testenv.properties"
  ...
  @Lazy String pluginClasspathString = {
    ClasspathSplitter.splitClasspath(pluginClasspathFiles)
  }()
  ...
  private File loadAndroidSdkFromProject() {
    ...
    while (file != null) {
      File localPropsFile = new File(file, ANDROID_SDK_FILE_NAME)
      ...
      File buildSrcFolder = new File(file, "buildSrc")
